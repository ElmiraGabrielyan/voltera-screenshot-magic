    ...
    <section className="py-32 bg-background">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="relative aspect-[3/4] bg-muted rounded-3xl overflow-hidden transform rotate-1 hover:rotate-0 transition-transform md:mt-12">
            <div className="absolute inset-0 bg-gradient-to-br from-gray-300 to-gray-400"></div>
          </div>
          <div className="relative aspect-[3/4] bg-muted rounded-3xl overflow-hidden transform -rotate-1 hover:rotate-0 transition-transform">
            <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300"></div>
          </div>
        </div>
      </div>
